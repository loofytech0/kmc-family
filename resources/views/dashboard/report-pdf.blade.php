...
<div>
  <table class="table-bio">
    <tr>
      ...
      <td>{{ $inspection->patient->name }}</td>
    </tr>
    <tr>
      <td style="width: 100px">Tanggal Lahir</td>
      <td style="width: 10px">:</td>
      <td>{{ date("d/m/Y", strtotime($inspection->patient->birth_date)) }}</td>
    </tr>
    <tr>
      <td style="width: 100px">Jenis Kelamin</td>
      <td style="width: 10px">:</td>
      <td>{{ $inspection->patient->gender == "L" ? "Laki - Laki" : "Perempuan" }}</td>
    </tr>
    <tr>
      <td style="width: 100px">Agama</td>
      <td style="width: 10px">:</td>
      <td style="text-transform: capitalize">{{ $inspection->patient->religion }}</td>
    </tr>
    <tr>
      <td style="width: 100px">Suku</td>
      <td style="width: 10px">:</td>
      <td style="text-transform: capitalize">{{ $inspection->patient->ethnic }}</td>
    </tr>
    <tr>
      <td style="width: 100px">Pendidikan</td>
      <td style="width: 10px">:</td>
      @if ($inspection->patient->education == "d3")
        <td style="text-transform: capitalize">D-III</td>
      @elseif ($inspection->patient->education == "d4")
        <td style="text-transform: capitalize">D-IV</td>
      @else
        <td style="text-transform: capitalize">{{ $inspection->patient->education }}</td>
      @endif
    </tr>
    <tr>
      <td style="width: 100px">Pekerjaan</td>
      <td style="width: 10px">:</td>
      @if ($inspection->patient->job == "tidak_bekerja")
        <td>Tidak Bekerja</td>
      @endif
      @if ($inspection->patient->job == "pns")
        <td>PNS</td>
      @endif
      @if ($inspection->patient->job == "tni_polri")
        <td>TNI / POLRI</td>
      @endif
      @if ($inspection->patient->job == "bumn")
        <td>BUMN</td>
      @endif
      @if ($inspection->patient->job == "pegawai_wirausaha")
        <td>Pegawai Swasta / Wirausaha</td>
      @endif
      @if ($inspection->patient->job == "pelajar_mahasiswa")
        <td>Pelajar / Mahasiswa</td>
      @endif
      @if ($inspection->patient->job == "other")
        <td>Lain - Lain</td>
      @endif
    </tr>
    <tr>
      ...
      <td style="width: 10px">:</td>
      <td>{{ $inspection->patient->address }}</td>
    </tr>
  </table>
</div>
<div style="">
  <div style="margin-bottom: 20px">ANAMNESIS PENYAKIT</div>
  ...
  <div style="margin-top: 20px; margin-bottom: 20px">ANAMNESIS PENGALAMAN SAKIT (ILLNESS)</div>
  ...
  <div style="margin-top: 20px; margin-bottom: 20px">INSTRUMEN PENILAIAN KELUARGA (FAMILY ASSESMENT TOOLS)</div>
  <div class="grid grid-cols-2 gap-5 mb-6">
    <div class="flex flex-col gap-1">
  ...
  <div style="margin-top: 20px; margin-bottom: 20px">
    <span>SCREEM Keluarga (Family SCREEM) :</span>
    <textarea
      rows="4"
      class="border-0 shadow-none outline-none"
  ...
  <div style="margin-top: 20px; margin-bottom: 20px">PEMERIKSAAN FISIK</div>
  ...
  <h4 style="margin-top: 70px">LAIN-LAIN (TERMASUK DATA DARI OBSERVASI RUMAH PASIEN)</h4>
  <table>
    <tr>
